...
export const GanttSidebar: FC<GanttSidebarProps> = ({
  ...
  <div
    ...
    className={cn(
      "sticky left-0 z-30 h-max min-h-full text-clip border-r border-border/50 bg-background/90 backdrop-blur-md",
      className
    )}
  >
    <GanttSidebarHeader />
...
export const GanttTimeline: FC<GanttTimelineProps> = ({
  ...
  <div
    className={cn("relative flex h-full w-max flex-none text-clip", className)}
  >
    {children}
  </div>
)
