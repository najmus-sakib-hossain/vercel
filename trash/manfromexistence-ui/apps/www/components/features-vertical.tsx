      ...
      <div className="container">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto my-12 grid h-full items-center gap-10 lg:grid-cols-2">
                ...
                {data.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="relative flex items-center">
                      <div className="item-box mx-2 flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-primary/10 sm:mx-6">
                        {item.icon}
                      </div>
                      ...
                      <div>
                        ...
                        <AccordionTrigger className="justify-start text-left font-sans text-[16px] leading-4">
                          {item.content}
                        </AccordionTrigger>
                      </div>
                    </div>
            ...
            <div
              className={`flex h-[350px] min-h-[150px] w-auto justify-center  ${
                ltr && 'lg:order-1'
              }`}
            >
